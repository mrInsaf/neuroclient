...
def combine_files_by_suffixes(suffixes, exclude_dirs=None, output_file='combined.txt', use_relative_path=True):
    """
    Рекурсивно проходит по текущей директории и объединяет содержимое файлов с заданными суффиксами.

    :param suffixes: Список расширений для поиска, например ['.txt', '.py']
    ...
    print(f"Файлы с суффиксами {suffixes} успешно объединены в '{output_path}'.")


# Пример вызова функции
combine_files_by_suffixes(['.js', '.html', '.css'])